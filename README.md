...
<p align="center">
  <img src="./docs/screenshots/new-case.png" alt="Mju 新建案件" width="32%" />
  <img src="./docs/screenshots/case-board-running.png" alt="Mju 运行中的案件看板" width="32%" />
  <img src="./docs/screenshots/dates.png" alt="Mju 全局 Dates" width="32%" />
</p>

> 截图展示的目标状态：工具页（确定性计算引擎）、四列看板（含待验收列）、Dates 视图（含待确认期限与到期倒计时）。请参见各 PR 合入后补录。
